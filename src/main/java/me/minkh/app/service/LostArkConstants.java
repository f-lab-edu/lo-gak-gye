...
public final class LostArkConstants {
    ...
    public static final double SHARP_BLUNT_ADJUSTMENT = 0.98;
    public static final int BASIC_CRITICAL_DAMAGE = 200;
    public static final double SHARP_BLUNT_CRITICAL_DAMAGE = 0.5;
    public static final double BLITZ_COMMANDER_COEFFICIENT = 0.45;
    public static final double BLITZ_COMMANDER_MAX_EFFICIENCY = 18.0;
}
