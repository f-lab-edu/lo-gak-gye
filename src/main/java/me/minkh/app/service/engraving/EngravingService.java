...
public class EngravingService {
    ...
    public List<CalcEngravingResponseDto> calcEngravings(CalcEngravingRequestDto dto) {
        ...
        return List.of(
                new CalcEngravingResponseDto(SHARP_BLUNT, combatAttribute.calcSharpBlunt()),
                new CalcEngravingResponseDto(BLITZ_COMMANDER, combatAttribute.calcBlitzCommander()),
                new CalcEngravingResponseDto(CURSED_DOLL, combatAttribute.calcCursedDoll(attackIncrease))
        );
    }
